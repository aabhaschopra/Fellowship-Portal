...
import com.example.laaliproject.FinalStudentDetails;
            ...
            protected void populateViewHolder(Student_ViewHolder viewholder, Student user, int i) {
                ...
                viewholder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent det = new Intent(MPMentorStudents.this, FinalStudentDetails.class);
                        det.putExtra("UserID", userAdapter.getRef(position).getKey());
                        startActivity(det);
                    }
                });
            }
